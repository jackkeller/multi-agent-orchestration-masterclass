...
const Coordinator_1 = require("../core/Coordinator");
const ResearchWorker_1 = require("../workers/ResearchWorker");
const ImplementWorker_1 = require("../workers/ImplementWorker");
const VerifyWorker_1 = require("../workers/VerifyWorker");
/**
...
async function runBasicOrchestrator() {
    ...
    const messageBus = new MessageBus_1.MessageBus();
    // Create coordinator
    const coordinator = new Coordinator_1.Coordinator(messageBus, {
        maxParallelWorkers: 4,
        defaultTimeoutMs: 30000
    });
    // Create and register workers
    console.log('🤖 Creating workers...\n');
    const researchWorker1 = new ResearchWorker_1.ResearchWorker({ id: 'researcher-1', type: 'research', maxConcurrentTasks: 2, timeoutMs: 10000 }, messageBus);
    coordinator.registerWorker({ id: 'researcher-1', type: 'research', maxConcurrentTasks: 2, timeoutMs: 10000 });
    const researchWorker2 = new ResearchWorker_1.ResearchWorker({ id: 'researcher-2', type: 'research', maxConcurrentTasks: 2, timeoutMs: 10000 }, messageBus);
    coordinator.registerWorker({ id: 'researcher-2', type: 'research', maxConcurrentTasks: 2, timeoutMs: 10000 });
    const implementWorker = new ImplementWorker_1.ImplementWorker({ id: 'implementer-1', type: 'implement', maxConcurrentTasks: 2, timeoutMs: 15000 }, messageBus);
    coordinator.registerWorker({ id: 'implementer-1', type: 'implement', maxConcurrentTasks: 2, timeoutMs: 15000 });
    const verifyWorker = new VerifyWorker_1.VerifyWorker({ id: 'verifier-1', type: 'verify', maxConcurrentTasks: 3, timeoutMs: 20000 }, messageBus);
...
//# sourceMappingURL=01-basic-orchestrator.js.map